        ...
        {!isCartEmpty ? (
          <>
            ...
            <div className="flex justify-between mt-8 space-x-4">
              ...
              <Link
                to="/checkout"
                className="py-2 px-4 bg-primary dark:bg-light text-white dark:text-black text-xl font-semibold rounded-sm flex justify-center items-center hover:bg-dark dark:hover:bg-lighter transition cursor-pointer"
              >
                Proceed to Checkout
              </Link>
            </div>
