...
export default function Messages() {
  ...
  return (
    <div className="grow min-h-213 container mx-auto px-6 py-12 font-primary dark:bg-darkbg">
      {messages.length === 0 ? (
            ...
            <tbody>
              {messages.map((message) => (
                ...
                >
                  ...
                  <td className="border px-4 py-2 wrap-break-word max-w-75 overflow-auto">
                    {message.message}
                  </td>
